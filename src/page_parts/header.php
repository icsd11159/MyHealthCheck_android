    ...
    <div class="container">
        <div class="navbar-header">
            ...
            if (isset($_SESSION['login_state']) && $_SESSION['login_state'] == true) {
                if (isset($_SESSION['role']) && !empty($_SESSION['role'])) {
                    if ($_SESSION['role'] == 0) {
                        echo '<a class="navbar-brand" href="index.php">Πλατφόρμα Ιατρού</a>';
                    } else if ($_SESSION['role'] == 1) {
                        echo '<a class="navbar-brand" href="index.php">Πλατφόρμα Ασθενούς</a>';
                    }
                } else {
                    echo '<a class="navbar-brand" href="index.php">Πλατφόρμα Μικροβιολογικών Εξετάσεων</a>';
                }
            } else {
                echo '<a class="navbar-brand" href="index.php">Πλατφόρμα Μικροβιολογικών Εξετάσεων</a>';
            }
        ...
        if (isset($_SESSION['login_state']) && !empty($_SESSION['login_state'])) {
            if ($_SESSION['login_state'] == true) {
                ...
                if ($user_role == 0) {
                    include_once "header_options_doctors.php";
                } else if ($user_role == 1) {
                    include_once "header_options_patients.php";
                }
                //  }
            }
        }
